...
export const Input = ({ type, placeholder, icon: Icon, register = () => { }, name, rules, data = "" }) => {
  ...
  return (
    <InputContainer>
      <InputWrapper>
        <InputType {...register(name, rules)} placeholder={placeholder} type={typeInput} defaultValue={data} />
        {type === "password" && (
